module.exports = {
  kod: {
    ...
    content:
      'Do umieszczenia kodu służy specjalny bloczek:\n' +
      '\\`\\`\\`język\n' +
      'kod\n' +
      '\\`\\`\\`\n' +
      'Gdzie jako _język_ wpisz: `cpp`, `java`, `js`, `php`, `py`, `html`, `css` itp., na przykład:\n' +
      '\\`\\`\\`py\n' +
      "print('Hello world')\n" +
      '\\`\\`\\`\n' +
  ...
  pytanie: {
    ...
    content:
      "Nie pytaj, czy możesz zapytać albo czy znajdzie się specjalista z danej dziedziny. Po prostu zadaj właściwe pytanie, czyli opisz szczegółowo swój problem, wstaw kod, pokaż ewentualne błędy. Jeżeli ktoś będzie wiedział, to na pewno spróbuje Ci pomóc.\n_[Don't ask to ask, just ask](https://dontasktoask.com)_",
  },
  gotowce: {
    title: 'Nie dajemy gotowców',
    content:
      'Wybacz, ale nikt nie odrobi Twojego zadania dla Ciebie, jeżeli sam nie masz ochoty zrobić nic. Nawet gdyby tak się stało, to problem powróci już przy kolejnym zadaniu - otrzymując tylko rozwiązanie nadal się niczego nie nauczysz.\n\nZaangażuj się, poszukaj, spróbuj sam. Zapytaj konkretnie czego nie wiesz i powiedz jak możemy Ci pomóc, a wtedy pewnie ktoś spróbuje doradzić.',
  },
  irc: {
    title: 'Połączenie z IRC',
    content:
      'Spokojnie, osoby wypowiadające się podobnie do ludzi z plakietką BOT, nie są rzeczywistymi botami. To prawdziwe osoby z naszego dawnego [czatu IRC](https://forum.pasja-informatyki.pl/chat-irc), z którego wiadomości na kanale #offtop są synchronizowane. Warto wiedzieć, że większość opcji formatowania z Discorda nie zadziała właściwie na [IRC](https://pl.wikipedia.org/wiki/Internet_Relay_Chat).',
  },
  test: {
    title: 'test',
    content: 'test....',
