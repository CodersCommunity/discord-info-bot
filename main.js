...
client.on('ready', () => {
    ...
    client.on('message', async (message) => {
        console.log('message.content:', message.content,
            ...
            ' /id:',message.id,
            ' /author lastMessageID:', message.author.lastMessageID)
    ...
    client.ws.on('INTERACTION_CREATE', interaction => {
        console.log('interaction:', interaction, ' /isTrivialQuestion(interaction.data.name):',isTrivialQuestion(interaction.data.name));
